...
- [ ] Fix config code
  ...
  - [x] De-dup the code that auto-creates default config and secret files.
  ...
  - [x] Proxies::should_allow needs to apply normalization. Or just switch to a `Hostname` newtype.
